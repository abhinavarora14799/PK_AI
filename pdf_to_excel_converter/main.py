# Main script to run the PDF to Excel conversion # main.py
import os
import gc
import sys
import shutil
...
def run_extraction(pdf_path: str, output_excel_filename: str):
    """
    Main function to run the PDF to Excel conversion process.
    """
    ...
    try:
        ...
        print("\n[Step 2/4] Performing OCR (text and table recognition) on images...")
        ocr_processor = None
        all_extracted_data = []
        ...
        try:
            ...
            if not all_dataframes:
                print("[!] No structured tables found or extracted from the PDF. Exiting.")
                return False
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Convert PDF with handwritten notes to Excel.")
    ...
    # Example Usage:
    # python main.py my_handwritten_notes.pdf -o my_notes_table.xlsx
